...
### These are some of my current skill sets:
 [![My Skills](https://skillicons.dev/icons?i=c,cpp,cmake,python,verilog,java,github,gitlab,matlab,powershell,visualstudio,vscode,pycharm,idea,ros,linux,windows,raspberrypi,arduino,html,css,bootstrap,wordpress&perline=11)](https://skillicons.dev)
