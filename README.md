...
### These are some of my current skill sets:
 [![My Skills](https://skillicons.dev/icons?i=c,cpp,python,java,github,matlab,terminal,visualstudio,vscode,pycharm,idea,linux,windows,raspberrypi,arduino,html,css,wordpress&perline=11)](https://skillicons.dev)
