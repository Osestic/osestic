...
### These are some of my current skill sets:
 [![My Skills](https://skillicons.dev/icons?i=c,cpp,cmake,python,java,github,gitlab,jira, confluence,matlab,powershell,visualstudio,vscode,pycharm,idea,ros,linux,windows,raspberrypi,arduino,html,css,bootstrap,wordpress&perline=11)](https://skillicons.dev)
